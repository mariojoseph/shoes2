...
// 	// wp_redirect(site_url('/'));
// }
// add_action('redirect_myregistration','redirect_registration_page');

// function registration_redirect1(){

// 	wp_redirect(site_url('/'));
// 	exit;
// }

// add_action( 'registration_redirect', 'registration_redirect1');
...
// //     wp_register_script( 'network-js', $directory.'js/network.js', array('jquery'), false, true  );
