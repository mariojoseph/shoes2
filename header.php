...
<div class="site-header__menu">
 ...
 <div class="site_header__menu_util">
  ...
  <div class="site-header__menu_items">
      ...
      <div class="site-header__menu_items__about"><i class="fa fa-users" style="color: gold;" aria-hidden="true" style="color: white;"></i><a href="<?php echo esc_url(site_url('brands')); ?>" >&nbsp Popular Shoe Types</a></div>
