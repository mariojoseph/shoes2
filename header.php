...
<div class="site-header__menu">
 ...
 <div class="site_header__menu_util">
  ...
  <div class="site-header__menu_items">
      ...
      <div class="site-header__menu_items__about"><i class="fa fa-th-list" style="color: orange;" aria-hidden="true" ></i><a href="<?php echo esc_url(site_url('popular-shoe-sites')); ?>" >&nbsp Popular Shoe Websites</a></div>
