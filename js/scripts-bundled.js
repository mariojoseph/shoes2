...
var postShoes = new _postShoes.default();
var postShoesCountry = new _postShoesCountry.default();
var messages = new _messages.default();
...
function () {
  function Gallery() {
    ...
    this.modal = document.querySelector('.front-page-modal');
    this.imgTotal = document.querySelector('.imgs');
    this.imgMain = document.querySelector('.main-img');
    this.opacity = 0.6;
  ...
  _createClass(Gallery, [{
    ...
    value: function events() {
      ...
      if (document.URL === 'https://www.haveyouseenmyshoes.com/' || document.URL === 'http://localhost:3000/') {
        ...
        this.closeImage.addEventListener('click', this.closingImage.bind(this)); // More Info Click
    ...
    value: function imgClick(e) {
      ...
      this.current.src = e.target.src; // Add fade in class
...
function () {
  function PostShoes() {
    _classCallCheck(this, PostShoes);
  ...
  _createClass(PostShoes, [{
    key: "events",
    value: function events() {
      // IMAGE CONTROL EVENTS
      // 	IMAGE CONTROL EVENTS - Show Select File dialog
      document.querySelector("#upload-dialog").addEventListener('click', this.uploadDialog); //   IMAGE CONTROL EVENTS - Selected File has changed

      document.querySelector("#fileInput").addEventListener('change', this.fileChange); //   IMAGE CONTROL EVENTS - Reset file input

      document.querySelector("#cancel-image").addEventListener('click', this.resetFile);
      (0, _jquery.default)(".ShoesSubmit-note").on("click", this.createNote.bind(this));
    } // Image creation
    ...
    value: function uploadDialog() {
      ...
      if (uploadDialogBox.getAttribute('data-logged') == 'no') {
        ...
        setTimeout(function () {
          window.location.href = "https://www.haveyouseenmyshoes.com/wp-login.php?redirect_to=post-your-shoes"; // window.location.href = "http://localhost:3000/wp-login.php?redirect_to=post-your-shoes";
    ...
    value: function fileChange() {
      ...
      document.querySelector("#upload-dialog").style.display = 'none'; // set name of the file

      document.querySelector("#image-name").innerText = file.name;
      document.querySelector("#image-name").style.display = 'inline-block'; // local url

      this._PREVIEW_URL = URL.createObjectURL(file); // console.log("value is " + this._PREVIEW_URL);
      // set src of image and show

      document.querySelector("#preview-image").setAttribute('src', this._PREVIEW_URL);
      document.querySelector("#preview-image").style.display = 'inline-block'; // show cancel and upload buttons now

      document.querySelector("#cancel-image").style.display = 'inline-block'; // document.querySelector("#upload-button").style.display = 'inline-block';
      ...
      reader.onload = function (e) {
        ...
        if (width < 400 || height < 400) {
          ...
          console.log("width is ".concat(width, " and height is ").concat(height));
        }
      };

      reader.readAsDataURL(file); // console.log(reader);
      // END AGAIN TRYING
      // END NOW
    }
  }, {
    key: "readImageFile",
    value: function readImageFile(textToShow) {
      var message = document.querySelector('.post-grid1-left-bottom-photo p');
    ...
    value: function resetFile() {
      ...
      document.querySelector("#cancel-image").style.display = 'none'; // document.querySelector("#preview-image").style.display = 'none';
      // reset to no selection

      document.querySelector("#image-file").value = ''; // hide elements that are not required
      // // document.querySelector("#image-name").style.display = 'none';
...
var PostShoesCountry =
/*#__PURE__*/
function () {
  function PostShoesCountry() {
  ...
  _createClass(PostShoesCountry, [{
    ...
    key: "obtainJSONFile",
    value: function obtainJSONFile(searchBox) {
      ...
      xhrCountry.onload = function () {
        ...
        var selectID = document.getElementById('countrylist1');
        var fits = countries.filter(function (country) {
    ...
    key: "outputHTML",
    value: function outputHTML(fits) {
      console.log(fits);
    }
  }]);

  return PostShoesCountry;
}();

var _default = PostShoesCountry;
exports.default = _default;
...
function () {
  function Like() {
    ...
    this.likeResponse = (0, _jquery.default)(".like-response");
    this.events();
  }
...
function () {
  ...
  _createClass(Messages, [{
    key: "events",
    value: function events() {// this.ShoesSubmitNote.addEventListener('click', ()=>{
    ...
    key: "imgClick",
    value: function imgClick(e) {// // Modaly Set Up
    ...
    key: "closingImage",
    value: function closingImage() {// this.imgMain.style.display = 'none';
      // this.modal.style.display = 'none';
    }
  }, {
    key: "moreInfo",
    value: function moreInfo() {// window.open(this.link,"_self - URL");
      // console.log(this.parentElement.parentElement);
      // window.open(this.link, "_self");
    }
  }]);
