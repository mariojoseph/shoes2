...
function () {
  ...
  _createClass(PostShoes, [{
    ...
    value: function fileChange() {
      ...
      var mime_types = ['image/jpeg', 'image/png']; // validate MIME
      ...
      var mario = this.readImageFile(file); // validation is successful
      ...
      console.log("value is " + this._PREVIEW_URL); // set src of image and show
    ...
    key: "readImageFile",
    value: function readImageFile(file) {
