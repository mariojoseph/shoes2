                  ...
                  $brandImage1 = wp_get_attachment_image_src($brandImage['id'], $brandImageSize);
                     ?>
                                <div class="brands-thumbnails-slider">
                                    <a href="<?php echo esc_url(the_permalink()); ?>">  <img class="brands-thumbnails-slider-img" src="<?php echo esc_url($brandImage1[0]); ?>" alt="shoe1"></a>
                                    <div class="brands-thumbnails-slider-like">
                                        
                                    <span class="like-boxF" data-exists="<?php print_r($existStatusF) ?>">
                                        <a href="<?php echo esc_url(the_permalink()); ?>"><p><?php esc_html(the_title()); ?></p></a>
                                    </span>
                  ...
                  $brandImage1 = wp_get_attachment_image_src($brandImage['id'], $brandImageSize);
                     ?>
                                <div class="brands-thumbnails-slider">
                                    ...
                                    <span class="like-boxF" data-exists="<?php print_r(esc_attr($existStatusF)) ?>">
                                    <a href="<?php echo esc_url(the_permalink()); ?>"><p><?php esc_html(the_title()); ?></p></a>
                                    </span>
